...
function SMARTBUFF_InitSpellIDs()
  ...
  SMARTBUFF_DEMONSKINR1     = GetSpellInfo(687);--"Demon Skin Rank 1"
  SMARTBUFF_DEMONSKINR2     = GetSpellInfo(696);--"Demon Skin Rank 1"
...
--	  {SMARTBUFF_ARCANEINTELLECT, 60, SMARTBUFF_CONST_GROUP, {32}, "HPET;WPET;DKPET"}
  ...
  if (SMARTBUFF_PLAYERCLASS == "WARLOCK") then
    SMARTBUFF_BUFFLIST = {
      ...
      {SMARTBUFF_DEMONSKINR1, 0.025, SMARTBUFF_CONST_SELF},
      {SMARTBUFF_DEMONSKINR2, 0.025, SMARTBUFF_CONST_SELF},
    };
  end
