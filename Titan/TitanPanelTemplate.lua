...
local function TitanTooltip_SetPanelTooltip(self, id, frame)
	...
	local bar = ""
	if TITAN_PANEL_DISPLAY_PREFIX~=nil then bar = bar..TITAN_PANEL_DISPLAY_PREFIX; end
	if TitanUtils_GetWhichBar(id)~=nil then bar = bar..TitanUtils_GetWhichBar(id); end
